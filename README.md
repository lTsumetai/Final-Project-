[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/rmtn6Zv_)
# Milestone 3
...
2. Pada tugas Milestone 3, student akan diminta untuk membuat :
   1. `P2M3_<nama-student>_ddl.txt`
      - File ini berisi :
        ...
        + Syntax DML untuk melakukan insert data ke database. Anda dapat menggunakan sintaks Python atau non Python (seperti SQL atau yang lain) dalam hal ini.
        + Anda diwajibkan untuk menuliskan sintaks pembuatan table berbasiskan SQL (menggunakan `CREATE TABLE...`) sekalipun ketika melakukan insert data menggunakan non SQL.
